...
import Application.modelClass.processScheduling.PriorityModel;
...
class ProcessP {
    ...
    public ProcessP(String job, int at, int bt, int priority) {
        this.job = job;
        this.at = at;
        this.bt = bt;
...
public class PriorityPreController implements Initializable{
    @FXML
    ...
    public  TableView <PriorityModel> tableView;
    public  TableColumn<PriorityModel, String> processCol;
    public  TableColumn<PriorityModel, Integer> arrivalCol;
    public  TableColumn<PriorityModel, Integer> burstCol;
    public  TableColumn<PriorityModel, Integer> priorityCol;
    public  TableColumn<PriorityModel, Integer> ctCol;
    public  TableColumn<PriorityModel, Integer> tatCol;
    public  TableColumn<PriorityModel, Integer> wtCol;

    ObservableList<PriorityModel> observableList = FXCollections.observableArrayList();
...
//        completionArray.setSize(arrivalArray.size());
        ...
        while (!processes.isEmpty()){
            ...
            if (currentProcess.bt == 0) {
                ...
                completionArray.add(currentTime);
...
//        for (Table row : rows) {
//            observableList.add(new PriorityModel(row.job, row.at, row.bt, row.priority, row.ct, row.tat, row.wt));
//        }
